...
/**
 ...
 5. Создать класс Студент с полями имя (стринг), фамилия (стринг), группа (наш ссылочный тип данных)
        и набор сданных экзаменов (лист экзаменов).
    ...
    - метод, который получает название предмета (экзамена) и возвращает максимальную оценку по этому
        предмету.
 */