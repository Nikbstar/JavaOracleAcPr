...
/**
 ...
 5. Разработка, снованная на тестах
    Разработайте на основе тестов дин из следующих классов.
    Разработайте класс, представляющий студента. Студент характеризуется именем, фамилией, группой и набором экзаменов, которые он сдавал. Экзамен характеризуется названием предмета, оценкой студента по нему и датой сдачи (год, семестр). Группа характеризуется курсом и факультетом.
